      ...
      <main className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 pt-2">
                  ...
                  <div className="flex-shrink-0" style={{ marginLeft: "100px" }}>
                    ...
                    <a href={`/enroll?course=gemini&session=${selectedSession}`} className="px-8 font-bold rounded-full transition-colors shadow-lg text-base"
        ...
        <section id="enroll" className="py-16" style={{ backgroundColor: "#1B3A6B" }}>
          <div className="container max-w-2xl text-center space-y-6" style={{ color: "#F5F0E8" }}>
            ...
            <div>
              <a href={`/enroll?course=gemini&session=${selectedSession}`} className="inline-block font-bold rounded-full transition-colors shadow-xl"
